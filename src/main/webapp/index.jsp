...
<script type="text/javascript">
    //1.页面加载后，发送ajax请求获取分页数据
    //简言之，Ajax(Asynchronous JavaScript and XML)就是让JavaScript可以发送HTTP请求和接收HTTP响应
    $(function(){
        //去首页
        to_page(1);
    });
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            $("<tr></tr>").append(checkBoxTd)
                ...
                .append(deptNameTd)
                .append(btnTd)
                .appendTo("#emps_table tbody"); //利用id嵌入到table
        })
    }
    ...
    $("#emp_save_btn").click(function(){
        ...
        $.ajax({
            url:"${APP_PATH}/emps",
            type:"POST",
            data:$("#empAddModal form").serialize(), //自动转为Employee对象
            success:function(result){
    ...
    //1）、可以在创建按钮的时候绑定。    2）、绑定点击.live()，jquery新版没有live，使用on()进行替代
    ...
    $("#check_all").click(function(){
        //attr获取checked是undefined; attr获取自定义属性的值；
        //应该用prop修改和读取dom原生属性的值
