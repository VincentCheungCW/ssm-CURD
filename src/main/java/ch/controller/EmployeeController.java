...
public class EmployeeController {
    ...
    @ResponseBody
    public Msg getEmp(@PathVariable("id")Integer id){ //指定Integer id即为/emps/{id}之id
    ...
    /**
     * 如果直接发送ajax PUT请求
     * 封装的数据Employee:[empId=1014, empName=null, gender=null, email=null, dId=null]
     *
     * 问题：
     * 请求体中有数据；
     * 但是Employee对象封装不上；
    ...
    public Msg saveEmp(Employee employee, HttpServletRequest request){   //将/emps/{empId}中的empId映射到employee中的empId
